...
import { StyleSheet, Text,SafeAreaView, View, TouchableOpacity,Image, StatusBar,ScrollView, FlatList } from 'react-native'
...
const [selectedCategory, setSelectedCategory] = React.useState(1)
  ...
  function  renderHeader(profile){
      return (
      <View style={{flex:1, flexDirection:'row', paddingHorizontal:SIZES.padding, alignItems:'center', marginTop: StatusBar.currentHeight}}>
{/* Greetings */}
<View style={{flex:1}}>
                ...
                <View style={{ flexDirection: 'row', height: 70, backgroundColor: COLORS.secondary, borderRadius: SIZES.radius }}>
                    ...
                    >
                        <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            />
                            <Text style={{ marginLeft: 2, ...FONTS.body3, color: COLORS.white }}>Claim</Text>
                        </View>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <Text style={{ marginLeft: 2, ...FONTS.body3, color: COLORS.white }}>Get Point</Text>
                        </View>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <Text style={{ marginLeft: 2, ...FONTS.body3, color: COLORS.white }}>My Card</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </View>
